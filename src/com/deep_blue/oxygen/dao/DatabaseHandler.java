...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//Ajout des palanques
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE+") VALUES (1, 1, 1, 1, 'TECHNIQUE', 'AIR', 12, NULL, 900, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE+") VALUES (2, 1, 2, 2, 'ENCADRE', 'NITROX', 60, NULL, 2700, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE+") VALUES (3, 1, NULL, 3, 'AUTONOME', 'AIR', 25, NULL, 1800, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE+") VALUES (4, 2, NULL, 1, 'AUTONOME', 'AIR', 25, NULL, 1800, NULL);");
