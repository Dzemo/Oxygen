...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//Ajout des palanques
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE_MONITEUR+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE_MONITEUR+", "+PalanqueeDao.HEURE+") VALUES (1, 1, 1, 1, 'TECHNIQUE', 'AIR', 12, NULL, 900, NULL, '10:00');");
