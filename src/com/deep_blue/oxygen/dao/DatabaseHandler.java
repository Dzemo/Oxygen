...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("INSERT INTO "+AptitudeDao.TABLE_NAME+" ("+AptitudeDao.ID_WEB+", "+AptitudeDao.LIBELLE_COURT+", "+AptitudeDao.LIBELLE_LONG+", "+AptitudeDao.TECHNIQUE_MAX+", "+AptitudeDao.ENCADREE_MAX+", "+AptitudeDao.AUTONOME_MAX+", "+AptitudeDao.NITROX_MAX+", "+AptitudeDao.AJOUT_MAX+", "+AptitudeDao.ENSEIGNEMENT_AIR_MAX+", "+AptitudeDao.ENSEIGNEMENT_NITROX_MAX+", "+AptitudeDao.ENCADREMENT_MAX+") VALUES (3, 'PA-20', 'Plongé autonome 20m', 20, 20, 20, 0, 0, 0, 0, 0);");
		...
		db.execSQL("INSERT INTO "+AptitudeDao.TABLE_NAME+" ("+AptitudeDao.ID_WEB+", "+AptitudeDao.LIBELLE_COURT+", "+AptitudeDao.LIBELLE_LONG+", "+AptitudeDao.TECHNIQUE_MAX+", "+AptitudeDao.ENCADREE_MAX+", "+AptitudeDao.AUTONOME_MAX+", "+AptitudeDao.NITROX_MAX+", "+AptitudeDao.AJOUT_MAX+", "+AptitudeDao.ENSEIGNEMENT_AIR_MAX+", "+AptitudeDao.ENSEIGNEMENT_NITROX_MAX+", "+AptitudeDao.ENCADREMENT_MAX+") VALUES (7, 'PE-20', 'Plongé encadré', 20, 20, 0, 0, 0, 0, 0, 0);");
		...
		db.execSQL("INSERT INTO "+FicheSecuriteDao.TABLE_NAME+" ("+FicheSecuriteDao.ID_LOCAL+", "+FicheSecuriteDao.ID_EMBARCATION_WEB+", "+FicheSecuriteDao.ID_DIRECTEUR_PLONGE_WEB+", "+FicheSecuriteDao.TIMESTAMP+", "+FicheSecuriteDao.ID_SITE+", "+FicheSecuriteDao.ETAT+") VALUES (1, 1, 3, 1412931600, 1, 'SYNCHRONISE');");
		db.execSQL("INSERT INTO "+FicheSecuriteDao.TABLE_NAME+" ("+FicheSecuriteDao.ID_LOCAL+", "+FicheSecuriteDao.ID_EMBARCATION_WEB+", "+FicheSecuriteDao.ID_DIRECTEUR_PLONGE_WEB+", "+FicheSecuriteDao.TIMESTAMP+", "+FicheSecuriteDao.ID_SITE+", "+FicheSecuriteDao.ETAT+") VALUES (2, 1, 4, 1412935200, 2, 'SYNCHRONISE');");
		
		//PAS D'AJOUT D'HISTORIQUES !!
		
		//Ajout des palanques
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE_MONITEUR+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE_MONITEUR+") VALUES (1, 1, 1, 1, 'TECHNIQUE', 'AIR', 12, NULL, 900, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE_MONITEUR+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE_MONITEUR+") VALUES (2, 1, 2, 2, 'ENCADRE', 'NITROX', 60, NULL, 2700, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE_MONITEUR+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE_MONITEUR+") VALUES (3, 1, NULL, 3, 'AUTONOME', 'AIR', 25, NULL, 1800, NULL);");
		db.execSQL("INSERT INTO "+PalanqueeDao.TABLE_NAME+" ("+PalanqueeDao.ID+", "+PalanqueeDao.ID_FICHE_SECURITE+", "+PalanqueeDao.ID_MONITEUR_WEB+", "+PalanqueeDao.NUMERO+", "+PalanqueeDao.TYPE_PLONGE+", "+PalanqueeDao.TYPE_GAZ+", "+PalanqueeDao.PROFONDEUR_PREVUE+", "+PalanqueeDao.PROFONDEUR_REALISE_MONITEUR+", "+PalanqueeDao.DUREE_PREVUE+", "+PalanqueeDao.DUREE_REALISE_MONITEUR+") VALUES (4, 2, NULL, 1, 'AUTONOME', 'AIR', 25, NULL, 1800, NULL);");
