...
public class JsonRequestContainer {
	...
	public JsonRequestContainer(Long utilisateurMaxVersion,
			...
			Long siteMaxVersion, Long moniteurMaxVersion, List<FicheSecurite> fichesSecuriteValidees,
	...
	/**
	 * @param utilisateurMaxVersion the utilisateurMaxVersion to set
	 */
	...
	/**
	 * @param utilisateurLogin the utilisateurLogin to set
	 */
	...
	/**
	 * @param synchRetrieveLength the synchRetrieveLength to set
	 */
	...
	/**
	 * @param synchRetrieveTypeAll the synchRetrieveTypeAll to set
	 */
	...
	/**
	 * @param aptitudeMaxVersion the aptitudeMaxVersion to set
	 */
	...
	/**
	 * @param embarcationMaxVersion the embarcationMaxVersion to set
	 */
	...
	/**
	 * @param ficheSecuriteMaxVersion the ficheSecuriteMaxVersion to set
	 */
	...
	/**
	 * @param siteMaxVersion the siteMaxVersion to set
	 */
	...
	/**
	 * @param moniteurMaxVersion the moniteurMaxVersion to set
	 */
	...
	/**
	 * @param fichesSecuriteValidees the fichesSecuriteValidees to set
	 */
	public void setFichesSecuriteValidees(List<FicheSecurite> fichesSecuriteValidees) {
		this.fichesSecuriteValidees = fichesSecuriteValidees;
	}
	/**
