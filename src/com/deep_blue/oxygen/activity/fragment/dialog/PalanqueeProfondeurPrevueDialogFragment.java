...
public class PalanqueeProfondeurPrevueDialogFragment extends DialogFragment {
	private View rootView;
	private View dialogView;
	private Float profondeurParDefaut;
	private Palanquee palanquee;

	public PalanqueeProfondeurPrevueDialogFragment(View rootView, Palanquee palanquee) {
		super();
		this.rootView = rootView;
		this.palanquee = palanquee;
		if (palanquee.getProfondeurPrevue() != 0.0)
			profondeurParDefaut = palanquee.getProfondeurPrevue();
		else
			profondeurParDefaut = 20.0f;
	}
	...
	public void dismiss(boolean type) {	
		...
		if (type) {
			...
			palanquee.setProfondeurPrevue(total);
			
			((TextView) rootView
					.findViewById(R.id.textView_palanquee_info_profondeur_prevue_value))
					.setText(palanquee.getProfondeurPrevue() + " mètres");
		}
		super.dismiss();
	}
}